...
class SignIn extends Component {
  ...
  doSubmit = async () => {
    try {
      ...
      this.props.handleAuth(response.data.isShop ? "shopOwnerLogged" : "customerLogged");
      this.props.history.push(response.data.isShop ? "/shopowner" : "/customer");
    } catch (ex) {
      console.log(ex);
      const errors = { ...ex.response.data };
      console.log("error", ex.response);
      this.setState({ errors });
      alert(ex.response.data.general);
    }
